...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> ShowSearchResults(String JokeQuestion)
        {
            return _context.Joke != null ?
                        View("Index",await _context.Joke.Where(j=>j.JokeQuestion.Contains(JokeQuestion)).ToListAsync()) :
                        Problem("Entity set 'ApplicationDbContext.Joke'  is null.");
        }
